...
namespace Mindgaze.Languages.UWP
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "Mindgaze.Languages.UWP.ViewModels.{0}ViewModel, Mindgaze.Languages.UWP", viewType.Name.Substring(0, viewType.Name.Length - 4));
